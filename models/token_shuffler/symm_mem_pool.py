...
# ────────────────────────────────────────────────
class PooledSymmMemTokenShuffler(MoETokenShuffler):
    """
    ...
    def dispatch(self, tokens, expert_splits):
        ...
        expert_major_tokens, self.out_so = PooledSymmMemDispatchFunc.apply(
    ...
    def combine(self, expert_computed_tokens):
        return PooledSymmMemCombineFunc.apply(
...
# Dispatch Func
# ────────────────────────────────────────────────
class PooledSymmMemDispatchFunc(torch.autograd.Function):
    @staticmethod
    @nvtx_range("fw.PooledSymmMemDispatchFunc")
    ...
    @staticmethod
    @nvtx_range("bw.PooledSymmMemDispatchFunc")
...
# Combine Func
# ────────────────────────────────────────────────
class PooledSymmMemCombineFunc(torch.autograd.Function):
    @staticmethod
    @nvtx_range("fw.PooledSymmMemCombineFunc")
    ...
    @staticmethod
    @nvtx_range("bw.PooledSymmMemCombineFunc")
